...
btnLogin.addEventListener('click', function (somevent) {
  somevent.preventDefault(); // żeby się zatrzymało po clicku

  currentAcount = accounts.find(
    acc => acc.userName === inputLoginUsername.value
  ); // znajduje konto z tablicy na podstawie nazwy użytkownika
